...
const HeroSection = () => {
  ...
  return (
    <div className="sm:pl-12 flex justify-center items-center gap-12 flex-wrap p-16">
      <div className="sm:pl-12 w-[500px] flex justify-center items-start flex-col md:pl-2 ">
        <h1 className="text-5xl pb-8">{tittle} <span className="text-[#39DB4A]">{heading}</span></h1>
