  ...
  return (
    <div className="flex justify-evenly items-center flex-wrap">
      ...
      {menu.map((items) => {
        ...
        return (
          <div className="h-[350px] w-[280px] border-2 border-primary rounded-xl m-6 p-4  gap-4">
            <img className="h-[180px] w-[300px] mb-8" src={img} alt="" />
            <h2 className="font-bold text-primary mb-2"><span className="text-black">Tittle:</span> {title}</h2>
            {/* <p>{items.description}</p> */}
            <h5 className="font-bold text-primary mb-2">Price: {price}</h5>
